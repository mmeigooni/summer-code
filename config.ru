...
map "/class3" do
  ...
  [
    ...
    File.open('public/class3.html', File::RDONLY)
  ]
}
end
...
map "/class5" do
  ...
  [
    ...
    File.open('public/class5.html', File::RDONLY)
  ]
}
end
...
map "/class6" do
  ...
  [
    ...
    File.open('public/class6.html', File::RDONLY)
  ]
}
end
...
map "/class7" do
  ...
  [
    ...
    File.open('public/class7.html', File::RDONLY)
  ]
}
end
...
map "/class8" do
  ...
  [
    ...
    File.open('public/class8.html', File::RDONLY)
  ]
}
end
...
map "/maimonides" do
  ...
  [
    ...
    File.open('public/maimonides.html', File::RDONLY)
  ]
}
end
...
map "/wesley" do
  ...
  [
    ...
    File.open('public/wesley.html', File::RDONLY)
  ]
}
end
...
map "/cityschool" do
  ...
  [
    ...
    File.open('public/cityschool.html', File::RDONLY)
  ]
}
end
